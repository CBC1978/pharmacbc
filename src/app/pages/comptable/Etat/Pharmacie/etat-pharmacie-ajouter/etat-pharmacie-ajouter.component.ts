...
@Component({
  selector: 'app-etat-pharmacie-ajouter',
  standalone: true,
  imports: [SidebarAdminComponent,FormsModule, CommonModule, RouterOutlet, RouterLink,RouterLinkActive, ReactiveFormsModule],
  templateUrl: './etat-pharmacie-ajouter.component.html',
  styleUrl: './etat-pharmacie-ajouter.component.css'
})
export class EtatPharmacieAjouterComponent {
  ...
  Ajouter_etat() {
    if(this.etatForm.valid){
      this.etatService.Create_etat_pharmacie(this.etatForm.value).subscribe(response => {
